m4_define([INSTR_DISPATCH],
    ...
    m4_ifelse(INSTR_NEED_DISPATCH$1, [DO_DISPATCH], [goto *((void*) *(ip += m4_eval(INSTR_ARGS$1 + 1)));])
...
m4_define([INSTR_DISPATCH_EMPTY_IMPL],
    ...
    m4_ifelse(EMPTY_IMPL_NEED_DISPATCH$1, [DO_DISPATCH], [goto *((void*) *(ip += m4_eval(EMPTY_IMPL_ARGS$1 + 1)));], [])
])
