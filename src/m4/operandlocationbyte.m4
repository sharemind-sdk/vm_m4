...
OLB_DEFINE(ref_imm,         0x11, 2)
OLB_DEFINE(ref_reg,         0x12, 2)
OLB_DEFINE(ref_stack,       0x14, 2)
OLB_DEFINE(cref_imm,        0x21, 2)
OLB_DEFINE(cref_reg,        0x22, 2)
OLB_DEFINE(cref_stack,      0x24, 2)
OLB_DEFINE(mem_reg_imm,     0x31, 2)
OLB_DEFINE(mem_reg_reg,     0x32, 2)
OLB_DEFINE(mem_reg_stack,   0x34, 2)
OLB_DEFINE(mem_stack_imm,   0x71, 2)
OLB_DEFINE(mem_stack_reg,   0x72, 2)
OLB_DEFINE(mem_stack_stack, 0x74, 2)
